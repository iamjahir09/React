...
const Tasklist = ({data}) => {
  const tasks = [
    ...
    { priority: 'Low', date: '20 Oct 2025', title: 'Documentation', description: 'Update API documentation and create user guides for new features' },
    { priority: 'High', date: '21 Oct 2025', title: 'Bug Fixes', description: 'Critical bug fixes for payment gateway integration and user authentication' },
    { priority: 'Medium', date: '22 Oct 2025', title: 'Team Workshop', description: 'Conduct training session on new development tools and best practices' },
    { priority: 'High', date: '23 Oct 2025', title: 'Product Launch', description: 'Final preparations for the new product launch and marketing materials' },
    { priority: 'Low', date: '24 Oct 2025', title: 'Code Review', description: 'Review pull requests and provide feedback to team members' }
  ];
