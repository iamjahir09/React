          ...
          <form onSubmit={handleSubmit}>
            <div className='bg-white/90 backdrop-blur-sm border-2 border-white/20 shadow-2xl rounded-3xl py-8 px-6'>
              ...
              <div className='text-center mt-8'>
                <button type="submit" className='bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white font-bold py-4 px-12 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 outline-none' onClick={() => navigate('/main')}>
                  Submit
                </button>
              </div>
